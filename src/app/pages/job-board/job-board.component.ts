...
export class JobBoardComponent {
  jobData=[
    {
      title:'SAP PP-PI Consultant',location:'Bengaluru',jobType:'Permanent Position',experience:'Requires 7+ years’ experience in delivering solutions within the SAP PP-PI module.Able to setup all PP-PI master data',
...
{
  title:'Syteline Functional Consultant',location:'Bengaluru',jobType:'Permanent Position',experience:'We are looking for Syteline functional consultant to join our Syteline team and support us in our existing requirement.4+ years of Syteline Experience is required.',
    requirement:[]
},
{
  title:'Power BI Consultant',location:'Bengaluru',jobType:'Contract',experience:'We are looking for a Power BI Consultant who has good experience to build complex data model in power BI and develop advance report/Cubes in Power BI.',
    requirement:[]
},
{
  title:'.Net Consultant',location:'Bengaluru',jobType:'Permanent Position',experience:'4+ Years',
